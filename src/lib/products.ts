...
export const PRODUCTS: Product[] = [
  ...
  {
    slug: "monitoring-renewal",
    name: "Company Monitoring Renewal",
    eyebrow: "Monitoring",
    headline: "Extend your monitoring for another twelve months",
    tagline: "Renews your existing Company Monitoring plan for a further 12 months — your watched companies carry over unchanged.",
    price: 99,
    delivery: "Applied to your plan on payment",
    category: "service",
    taxCode: "txcd_10103001",
    certificateCount: 0,
    vatablePrice: 99,
    internalOnly: true,
    description: [
      "Renews an existing Company Monitoring plan for another twelve months. Your watched companies, alert history and settings carry over — the extra year is added to your current cover end date.",
      "If your plan has already lapsed, renewal reactivates it for twelve months from payment.",
    ],
    includes: [
      { title: "12 more months", detail: "Added on top of your current cover — you never lose paid time by renewing early." },
      { title: "Companies carry over", detail: "Your watched companies stay exactly as they are." },
      { title: "Uninterrupted alerts", detail: "Daily registry checks continue without a gap." },
    ],
    typicalUse: "Keeping continuous watch on counterparties and portfolio companies.",
  },
  {
