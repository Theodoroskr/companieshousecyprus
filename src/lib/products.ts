...
export const PRODUCTS: Product[] = [
...

  {
    ...
    description: [
      ...
      "We screen the company's current legal name, its previous names and — where recorded — corporate shareholders that are legal entities. Each source is checked separately and the report shows the result per source, so you can see exactly what was checked, when, and what was found.",
