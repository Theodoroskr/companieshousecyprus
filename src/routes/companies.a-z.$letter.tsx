...
export const Route = createFileRoute("/companies/a-z/$letter")({
  ...
  head: ({ params }) => ({
    meta: [
      ...
      { property: "og:url", content: `https://companieshousecyprus.com/companies/a-z/${params.letter.toLowerCase()}` },
    ],
    links: [{ rel: "canonical", href: `https://companieshousecyprus.com/companies/a-z/${params.letter.toLowerCase()}` }],
  }),
