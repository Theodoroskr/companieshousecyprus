...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "MTBEIotuYWiO_JYe55lmbr__YqBCeGmN84rzbxMWiJE" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      { rel: "icon", href: "/favicon.ico", sizes: "16x16 32x32 48x64" },
      { rel: "apple-touch-icon", href: "/apple-touch-icon.png", sizes: "180x180" },
      { rel: "alternate", type: "text/plain", title: "LLM guide", href: "/llms.txt" },
      { rel: "alternate", type: "text/plain", title: "AI crawler policy", href: "/ai.txt" },
    ],
  }),
